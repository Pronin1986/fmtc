...
func TestGetASCICode(t *testing.T) {
	var tests = []struct {
		...
		{tag{name: "bg", attr: map[string]string{"color": "red"}}, "\033[41m"},
		{tag{name: "bg", attr: map[string]string{"color": "blue"}}, "\033[44m"},
		{tag{name: "bg", attr: map[string]string{"color": "wrong"}}, ""},
		{tag{name: "b_blue"}, "\033[44m"},
		{tag{name: "b_red"}, "\033[41m"},
		{tag{name: "bred"}, ""},
		{tag{name: "b_rred"}, ""},
		{tag{name: "wrong"}, ""},
